...
Trustme は使うのは簡単だけど、いろいろ細かく指定できない。
もし本番でちゃんとした証明書がいるなら cryptography で書く
(Trustme はテスト用途に絞って cryptography を使いやすくラップしたもの)
...
- パスワード認証のユーザ名
- クライアント証明書の CN か SAN (これ間違い)

が使える。

[ACL file Plugin | Eclipse Mosquitto](https://mosquitto.org/documentation/plugins/acl-file/)

ACL ファイルの書き方はけっこうややこしそう...

上の訂正:

- `use_identity_as_username true` だと CN
